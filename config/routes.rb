Rails.application.routes.draw do
  ...
  namespace :app do
    ...
    resources :projects, except: [:show] do
      ...
      get '/tasks/:id/edit_due_date' => 'tasks#edit_due_date', as: 'edit_task_due_date'
      patch '/tasks/:id/update_due_date' => 'tasks#update_due_date', as: 'update_task_due_date'
      resources :tasks do
        resources :comments
      end
      resources :statuses, except: [:new]
      get 'statuses/:id/cancel_edit' => 'statuses#cancel_edit', as: 'cancel_status_edit'
    end
